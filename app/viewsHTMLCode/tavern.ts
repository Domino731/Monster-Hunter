...
export const getTavernHTMLCode = () : string => {
    return `
    <section class='tavern'>
            ...
            <div class='tavern__list'>
               ...
               <img src='./images/papyrus_1.png' alt='papyrus' class='tavern__papyrus'/>
               <img src='./images/papyrus_2.png' alt='papyrus' class='tavern__papyrus'/>
               <img src='./images/papyrus_3.png' alt='papyrus' class='tavern__papyrus'/>
               </div>    
            </div>
        </section>
    `
