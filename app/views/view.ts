...
export class Component {
   ...
   // user statistics generated by all items in the equipment, by pet and potions.
   // Needed to create missions based on this stats and items in blacksmith market 
   protected userStats: FullUserStats;
   // container with loading animation, needed to remove this container when classes initialize (scripts and others) his methods
   ...
   // (for example - pets section which doesnt have the  ability to toggle between content), you have to clear this bar -  this.clearMobileNav() method
   ...
   // function that  set the statistics based on equipment, potions and pet
   setHeroStats() {
      this.userStats = getFullUserStats(this.userData)
   }

   // method responsbile for fetching user data, and also there is data listener
   async getUserData() {
