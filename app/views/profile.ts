    ...
    async render() {
        this.root.innerHTML = `<div class='profile'> 
             ...
             <div class='profile__item'>
               ...
               <a href='https://www.freepik.com/vectors/background' target="_black">Background vector created by upklyak - www.freepik.com</a>
             ...
             <div class='profile__item'>
              ...
              <div class='profile__generalItem'> 
                 <div class='profile__generalImg'> <img src="/images/profile_elixir_slot.png" alt="Elixir slot #1"/></div>
                 <strong class='profile__generalText'> 123123123123123</strong>
              </div>
              <div class='profile__generalItem'> 
                 <div class='profile__generalImg'> <img src="/images/profile_elixir_slot.png" alt="Elixir slot #2"/></div>
                 <strong class='profile__generalText'> 123123123123123</strong>
              </div>
           </div>
           ...
           <table >
                 <tbody>
                   ...
                   <tr>
                    <td class='profile__item--name'> <img src="/images/stats_strength.png" alt="strength"/> <strong>Strength</strong></td>
                    <td class='profile__item--amount'>123123</td>
                    <td class='profile__item--cost'>
                    <img src="/images/coin.png" alt="coin"/>
                    <strong>123</strong>
                    </td>
                    <td class='profile__item--buyBtn'><div>+</div></td>
                   </tr>
                   <tr>
                  ...
                  <tr>
                  <td class='profile__item--name'> <img src="/images/stats_runner.png" alt="physical endurance"/> <strong>physical endurance</strong></td>
                  <td class='profile__item--amount'>123123</td>
                  <td class='profile__item--cost'>
                  <img src="/images/coin.png" alt="coin"/>
                  <strong>123</strong>
                ...
                <tr>
                <td class='profile__item--name'> <img src="/images/stats_defence.png" alt="Defence"/> <strong>Defence</strong></td>
                <td class='profile__item--amount'>123123</td>
                <td class='profile__item--cost'>
                <img src="/images/coin.png" alt="coin"/>
                <strong>123</strong>
              ...
              <tr>
              <td class='profile__item--name'> <img src="/images/stats_clover.png" alt="Luck"/> <strong>Luck</strong></td>
              <td class='profile__item--amount'>123123</td>
              <td class='profile__item--cost'>
              <img src="/images/coin.png" alt="coin"/>
              <strong>123</strong>
             ...
             <tr>
             <td class='profile__item--name profile__item--nameBlue'><strong>Chance for critical</strong></td>
             <td class='profile__item--amount profile__item--nameBlue'>11000</td>
            </tr>
