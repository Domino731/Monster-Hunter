...
/**
 * get html code for account section
 * @param userNick - current user nick
 * @param deleteCode - delete code which user must prescribe to delete his account
 */
    ...
    <div class='account__item glass' id='update-account'>
        ...
        <form id='account-update'>
            ...
            <div class='account__element'>
                ...
                <input type='text' name='email' value=${auth.currentUser.email}
